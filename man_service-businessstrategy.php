...
<head>
	...
	<title>Business Strategy - Management Consultancy | Optima</title>
			...
			<div class="bg-grey">
				<div class="container abc" style="padding-left: 50px;padding-right: 50px;padding-bottom: 50px;">
					...
					<div class="section-header text-center" >
						<h2 class="title" style="padding-top: 10vh;">Business Strategy</h2>
					</div>
...
<p><strong><u>Evaluate Organizational Structure</u>:</strong><br />
...
<p><strong><u>Analyze Internal Operations</u></strong><strong>:</strong><br />
