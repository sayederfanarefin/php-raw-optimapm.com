...
<head>
	...
	<title>IT Solutions - Management Consultancy | Optima</title>
...
<body>
	...
	<header>
		...
		<!-- <div class="bg-grey">
			<div class="container abc" style="padding-left: 50px;padding-right: 50px;">
				...
				<div class="section-header text-center" >
					<h2 class="title" style="padding-top: 10vh;">IT Solutions</h2>
				</div>
		...
		<h2 class="text-center" style="padding: 20px;">IT Solutions</h2>
	...
	<div class="row" >
		...
		<div class="col-md-10">
			...
			<div class="row abc" >
				...
				<div class="col-md-6">
					<img class="img-responsive" src="./img/management/IT_Solution/1.jpg" alt="">
			...
			<div class="row abc" >
				...
				<div class="col-md-6">
					<img class="img-responsive" src="./img/management/IT_Solution/2.jpg" alt="">
...
<h5 style="padding-top: 10px">Monitoring and Controlling</h5>
				...
				<div class="col-md-6">
					<img class="img-responsive" src="./img/management/IT_Solution/11.jpg" alt="">
			...
			<div class="row abc" >
				...
				<h3 class="text-center"> <br /><br />Program Management</h3>

				<div class="col-md-3">

					<img class="img-responsive" style="padding-top: 50px" src="./img/management/IT_Solution/9.jpg" alt="">
				...
				<div class="row abc" >
					...
					<div class="col-md-9">
						...
						<div class="col-md-3">
							...
							<img class="img-responsive" style="padding-top: 50px" src="./img/management/IT_Solution/5.jpg" alt="">
					...
					<div class="row abc" >
						...
						<div class="col-md-9">
							...
							<div class="col-md-3">
								...
								<img class="img-responsive" style="padding-top: 50px" src="./img/management/IT_Solution/8.png" alt="">
